...
namespace FrmMiniCalc
{
    public partial class MDIPrentacion : Form
    {
        ...
        {
            FrmMiniCalc frm = new FrmMiniCalc();
            frm.MdiParent = this;
            frm.Show();
            /*
        ...
        private void StatusBarToolStripMenuItem_Click(object sender, EventArgs e)
        {
           //statusStrip.Visible = statusBarToolStripMenuItem.Checked;
            FrmPlanilla frmp = new FrmPlanilla();
            frmp.MdiParent = this;
            frmp.Show();
        }
        ...
        private void maestroDeConceptoDeGastosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FrmConcepto frmco = new FrmConcepto();
